...
let icon1 = document.querySelector(".question-secondary-text").children[0];
...
let icon2 = document.querySelector(".question-secondary-text").children[0];
...
let icon3 = document.querySelector(".question-secondary-text").children[0];
...
let icon4 = document.querySelector(".question-secondary-text").children[0];
...
let icon5 = document.querySelector(".question-secondary-text").children[0];
...
let icon6 = document.querySelector(".question-secondary-text").children[0];
